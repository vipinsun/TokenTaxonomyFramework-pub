...
PROTO_PATH="${PROTO_PATH:-../../../.nuget/packages/google.protobuf.tools/3.11.2/tools}"
CSHARP_PLUGIN="${CSHARP_PLUGIN:-../../../.nuget/packages/grpc.tools/2.26.0/tools/macosx_x64/grpc_csharp_plugin}"
echo "paths:"
echo $PROTO_PATH
echo $CSHARP_PLUGIN
