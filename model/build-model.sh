...
PROTO_PATH="${PROTO_PATH:-../../../.nuget/packages/google.protobuf.tools/3.10.0/tools}"
...
cp ../tools/TaxonomyObjectModel/out/csharp/* ../tools/UI-Sandbox/UI-Sandbox/Models
