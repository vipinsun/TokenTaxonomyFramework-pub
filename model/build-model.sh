...
protoc --csharp_out=../tools/TaxonomyObjectModel/out/csharp --java_out=../tools/TaxonomyObjectModel/out/java --js_out=import_style=commonjs:../tools/TaxonomyObjectModel/out/js  --grpc-web_out=import_style=commonjs,mode=grpcwebtext:../tools/TaxonomyObjectModel/out/js --proto_path=./protos --proto_path=../../../../.nuget/packages/google.protobuf.tools/3.7.0/tools  --grpc_out ../tools/TaxonomyService/TaxonomyService ./protos/service.proto --plugin=protoc-gen-grpc=../../../../.nuget/packages/grpc.tools/1.21.0/tools/macosx_x64/grpc_csharp_plugin --plugin=protoc-gen-web
protoc --proto_path=./protos --proto_path=../../../../.nuget/packages/google.protobuf.tools/3.7.0/tools  --grpc_out=no_server:../tools/TaxonomyService/TaxonomyClient ./protos/service.proto --plugin=protoc-gen-grpc=../../../../.nuget/packages/grpc.tools/1.21.0/tools/macosx_x64/grpc_csharp_plugin
protoc --proto_path=./protos --proto_path=../../../../.nuget/packages/google.protobuf.tools/3.7.0/tools  --grpc_out=no_server:../tools/TTF-Web-Explorer/Model ./protos/service.proto --plugin=protoc-gen-grpc=../../../../.nuget/packages/grpc.tools/1.21.0/tools/macosx_x64/grpc_csharp_plugin
