...
public interface ArtifactOrBuilder extends
   ...
   * <code>.taxonomy.model.artifact.ArtifactType type = 1;</code>
   */
  org.tokentaxonomyinitiative.tokens.model.artifact.ArtifactType getType();
   ...
   * <code>.taxonomy.model.artifact.ArtifactDefinition definition = 7;</code>
   */
  org.tokentaxonomyinitiative.tokens.model.artifact.ArtifactDefinition getDefinition();
  /**
   * <pre>
   *Base, Behavior or Behavior group type indicated by ArtifactType
   * </pre>
   ...
   * <code>.taxonomy.model.artifact.ArtifactDefinition definition = 7;</code>
   */
  org.tokentaxonomyinitiative.tokens.model.artifact.ArtifactDefinitionOrBuilder getDefinitionOrBuilder();
   ...
   */
  java.util.List<org.tokentaxonomyinitiative.tokens.model.artifact.ArtifactFile> 
   ...
   * <code>repeated .taxonomy.model.artifact.ArtifactFile artifact_files = 8;</code>
   */
  org.tokentaxonomyinitiative.tokens.model.artifact.ArtifactFile getArtifactFiles(int index);
  /**
   * <pre>
   *loop through the files and read them in as bytes to produce a complete artifact object model instance.
   * </pre>
   ...
   * <code>repeated .taxonomy.model.artifact.ArtifactFile artifact_files = 8;</code>
   */
  java.util.List<? extends org.tokentaxonomyinitiative.tokens.model.artifact.ArtifactFileOrBuilder> 
   ...
   * <code>repeated .taxonomy.model.artifact.ArtifactFile artifact_files = 8;</code>
   */
  org.tokentaxonomyinitiative.tokens.model.artifact.ArtifactFileOrBuilder getArtifactFilesOrBuilder(
      int index);
