...
protoc --csharp_out=../tools/TaxonomyHost/TaxonomyClient --proto_path=./model/protos --proto_path=../../../../.nuget/packages/google.protobuf.tools/3.7.0/tools  --grpc_out=no_server:../tools/TaxonomyHost/TaxonomyClient ./model/protos/taxonomyservice.proto --plugin=protoc-gen-grpc=../../../../.nuget/packages/grpc.tools/1.20.1/tools/macosx_x64/grpc_csharp_plugin


cp ./out/csharp/* ../tools/ArtifactGenerator/ArtifactGenerator/Model

cp ./out/csharp/* ../tools/TaxonomyHost/TaxonomyModel
